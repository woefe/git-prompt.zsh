...
#### bash-git-prompt mimic
This example intends to mimic the [bash-git-prompt](https://github.com/magicmonty/bash-git-prompt) infomative git prompt for bash.
```zsh
# Preview:
# ~/workspace/git-prompt.zsh [master|✚1…1]
# 10:24 $ 
